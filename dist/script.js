...
var modals = function modals() {
  function bindModal(clickSelector, modalSelector, closeSelector) {
    var modal = document.querySelector(modalSelector);
    document.querySelectorAll(clickSelector).forEach(function (item) {
...
var tabs = function tabs(headerSelector, tabsSelector, contentSelector, active) {
